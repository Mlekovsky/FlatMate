...
namespace FlatMate_backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210425171822_ReceiptPayer")]
    partial class ReceiptPayer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlatMate_backend.Domain.Entities.Receipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlatMate_backend.Domain.Entities.UserReceiptPosition", b =>
                {
                    ...
                    b.HasKey("ReceiptPositionId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UserReceiptPosition");
                });
            ...
            modelBuilder.Entity("FlatMate_backend.Domain.Entities.ReceiptPosition", b =>
                {
                    b.HasOne("FlatMate_backend.Domain.Entities.Receipt", "Receipt")
                        .WithMany("Positions")
            ...
            modelBuilder.Entity("FlatMate_backend.Domain.Entities.UserReceiptPosition", b =>
                {
                    b.HasOne("FlatMate_backend.Domain.Entities.ReceiptPosition", "ReceiptPosition")
                        .WithMany("UserReceiptPositions")
                        .HasForeignKey("ReceiptPositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
